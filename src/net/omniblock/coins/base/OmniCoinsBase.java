package net.omniblock.coins.base;

import java.sql.SQLException;

import org.bukkit.entity.Player;

import net.omniblock.mysql.lib.make.MakeSQLQuery;
import net.omniblock.mysql.lib.make.MakeSQLUpdate;
import net.omniblock.mysql.lib.make.MakeSQLUpdate.TableOperation;
import net.omniblock.mysql.lib.type.TableType;
import net.omniblock.mysql.lib.util.Resolver;
import net.omniblock.mysql.lib.util.SQLResultSet;

public class OmniCoinsBase {

	public static final int BANK_INITIAL_EXP = 0;
	public static final int BANK_INITIAL_MONEY = 100;
	public static final int BANK_INITIAL_VIP_POINTS = 0;
	
	public static final int baseXP = 250;
	public static final float exponentXP = 1.02f;
	
	public static int getLevel(Player player) {
		return calculateLevel(OmniCoinsBase.getExp(player));
	}
	...
	public static int getPoints(String player) {
		...
		return BANK_INITIAL_VIP_POINTS;
	}
